...
__used __section("__versions") = {
	...
	{ 0x91871450, "netif_stacked_transfer_operstate" },
	{ 0xed016150, "netdev_upper_dev_link" },
	...
	{ 0x16b20b9a, "netdev_upper_dev_unlink" },
	...
	{ 0x2978afb3, "netdev_upper_get_next_dev_rcu" },
	{ 0x8d522714, "__rcu_read_lock" },
	{ 0x46c010ec, "usbnet_write_cmd" },
